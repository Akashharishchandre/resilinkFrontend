    ...
    return (
        <div className="h-screen bg-black flex  items-center justify-center overflow-hidden">
            <div className="rounded-lg max-w-md w-full flex flex-col items-center justify-center relative">
                <div className="absolute inset-0 transition duration-300 animate-pink blur  "></div>
                <div className="p-10 rounded-xl z-10 w-full h-full bg-black">
                    ...
                    <form className="w-full space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            <label
                                htmlFor="userName"
                                className="block text-lg font-medium text-gray-200">User Name</label>
                            <input
                                {...register('userName')}
                                id="userName"
                                type="text"
                        ...
                        <div>
                            <label htmlFor="userrole" className="block text-lg font-medium text-gray-200">
                                Select an Role
                            </label>
                            <select
                                {...register('userrole')}
                                id="userrole"
                                className="block appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-200 focus:border-gray-200"
                            >
