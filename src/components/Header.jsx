import homePageLogo from "../assets/images/homePageLogo.jpeg";
...
export const Header = ({ cartCount }) => {
    ...
    return (
        <nav id="header" className="bg-black text-white" style={{ height: '200px' }}>
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-0">
                <div className="logo-wrapper pl-4 flex items-center">
                    <Link to="/" className="toggleColor text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl">
                        <img src={homePageLogo} alt="logo" className="w-60 h-60 object-cover"/>
                    </Link>
                </div>
                <div className="nav-menu-wrapper flex items-center justify-between space-x-10">
                    <Link to="/" className="text-xl">Home</Link>
                    <Link to="#about" className="text-xl">Buy</Link>
                    <Link to="#about" className="text-xl">Rent</Link>
                    <Link to="/menu" className="text-xl">List Property</Link>
                </div>
